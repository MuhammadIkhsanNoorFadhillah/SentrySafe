...
<div class="mb-2">
    ...
    <table id="table" class="table table-bordered table-hover custom-table-class"> <!-- Menambahkan custom class -->
        ...
        <tbody>
            @foreach ($list_mikro as $perlindungan_mikro)
            <tr>
                <td>{{ $loop->iteration }}</td>
                <td>{{ $perlindungan_mikro->nama }}</td>
                <td>{{ $perlindungan_mikro->nama_produk}}</td>
                <td>{{ $perlindungan_mikro->tanggal_efektif }}</td>
                <td>{{ $perlindungan_mikro->premi }}</td>
                <td>{{ $perlindungan_mikro->masa_polis }}</td>
                <td>{{ $perlindungan_mikro->status }}</td>
               <td>
