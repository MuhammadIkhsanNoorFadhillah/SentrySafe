...
<head>
    ...
    <title>SentrySafe | Perlindungan Individu</title>
...
<body>
    ...
    <section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="../assets/img/individu.jpg">
        <div class="container py-md-15">
            <div class="row">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="post-header">
                        <h1 class="display-1 mb-3 text-white">Asuransi Individu</h1>
                        <p class="lead">Temukan berbagai solusi perlindungan individu yang dirancang khusus untuk memenuhi kebutuhan Anda, memastikan keamanan dan kesejahteraan Anda di setiap tahap kehidupan</p>
                    </div>
                </div>
            </div>
        </div>
  ...
  <div class="container px-10 py-14 py-md-16">
    <div class="row">
      <div class="col-lg-6 col-xl-5 col-xxl-4">
        <h2 class="fs-15 text-uppercase text-muted mb-3">Asuransi Individu</h2>
    ...
    <div class="row gx-md-8 gy-8 justify-content-center">
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/individu/sehat.png" alt="" />
          <div class="card-body">
            <h4>Asuransi Kesehatan</h4>
            <p class="mb-3">Menanggung biaya pengobatan, rawat inap, obat obatan dan perawatan kesehatan lainnya.</p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/individu/jiwa.png" alt="" />
          <div class="card-body">
            <h4>Asuransi Jiwa</h4>
            <p class="mb-3">Memberikan manfaat finansial kepada keluarga atau ahli waris jika tertanggung meninggal dunia.
</p>
            <a href="#" class="more hover link-primary">Pelajari Selengkapnya</a>
          </div>
          <!--/.card-body -->
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/individu/diri.png" alt="" />
          <div class="card-body">
            <h4>Asuransi Kecelakaan Diri</h4>
            <p class="mb-3">Menyediakan kompensasi jika terjadi kecelakaan yang menyebabkan cedera atau kematian.</p>
            <a href="#" class="more hover link-primary">Pelajari Selengkapnya</a>
          </div>
          <!--/.card-body -->
        </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/individu/nganggur.png" alt="" />
          <div class="card-body">
            <h4>Perlindungan Pengangguran</h4>
            <p class="mb-3">Memberikan dukungan keuangan jika seseorang kehilangan pekerjaan tanpa kesalahan sendiri.
</p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/individu/pendidikan.png" alt="" />
          <div class="card-body">
            <h4>Perlindungan Pendidikan</h4>
            <p class="mb-3">Merupakan rencana tabungan atau asuransi yang membantu membiayai pendidikan anak untuk masa depan mereka yang cerah.</p>
            <a href="#" class="more hover link-primary">Pelajari Selengkapnya</a>
          </div>
          <!--/.card-body -->
        </div>
                ...
                <div class="col-xl-4 col-lg-4 mb-50">
                    <div style="padding-left: 60px;" class="footer-widget">
                        ...
                        <div class="footer-text mb-7">
                            <p>
                                SentrySafe adalah perusahaan asuransi yang berbasis di Indonesia. Didirikan pada tahun 2024, SentrySafe menyediakan berbagai produk asuransi, termasuk asuransi properti, kecelakaan, kendaraan bermotor, dan asuransi jiwa.</p>
                        </div>
