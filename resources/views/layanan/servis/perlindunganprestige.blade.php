...
<head>
    ...
    <title>SentrySafe | Perlindungan Prestige</title>
...
<div class="content-wrapper">
    ...
    <section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="../assets/img/prestige.jpg">
        <div class="container py-md-15">
            <div class="row">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="post-header">
                        <h1 class="display-1 mb-3 text-white">Asuransi Eksklusif</h1>
                        <p class="lead fs-14">"Raih ketenangan dan perlindungan optimal dengan <span class="underline-3 style-2 blue">Perlindungan Prestige</span> kami! Pastikan Anda dan keluarga terlindungi dengan layanan eksklusif dan manfaat premium. Daftar sekarang untuk keamanan masa depan yang tak ternilai!"</p>
                    </div>
                </div>
            </div>
        </div>
  ...
  <div class="container px-10 py-14 py-md-16">
    <div class="row">
      <div class="col-lg-6 col-xl-5 col-xxl-4">
        <h2 class="fs-15 text-uppercase text-muted mb-3">Perlindungan Prestige</h2>
        <h3 class="display-4 mb-7 mt-n2">Jenis Asuransi Eksklusif Yang Kami Tawarkan</h3>
      </div>
      <!-- /column -->
    </div>
    <!-- /.row -->
    <div class="row gx-md-8 gy-8 justify-content-center">
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/pendidikanelite.jpg" alt="" />
          <div class="card-body">
            <h4>Perlindungan Pendidikan Elite</h4>
            <p class="mb-3">Beri anak Anda pendidikan terbaik dengan perlindungan yang menjamin masa depan.</p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/kesehatanpremium.jpg" alt="" />
          <div class="card-body">
            <h4>Perlindungan Kesehatan Premium</h4>
            <p class="mb-3">Dapatkan perawatan kesehatan terbaik dengan akses prioritas perlindungan premium kami!</p>
            <a href="#" class="more hover link-primary">Pelajari Selengkapnya</a>
          </div>
          <!--/.card-body -->
        </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/eksclusivelife.jpg" alt="" />
          <div class="card-body">
            <h4>Asuransi Jiwa Eksklusif</h4>
            <p class="mb-3">Berikan warisan abadi untuk keluarga Anda. Lindungi mereka dengan asuransi jiwa eksklusif yang dirancang untuk Anda.</p>
            <a href="#" class="more hover link-primary">Pelajari Selengkapnya</a>
          </div>
          <!--/.card-body -->
        </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/barang.jpg" alt="" />
          <div class="card-body">
            <h4>Perlindungan Barang Mewah</h4>
            <p class="mb-3">Amankan barang-barang mewah Anda dari segala risiko. Lindungi aset berharga dengan perlindungan khusus kami.</p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/bencana.jpg" alt="" />
          <div class="card-body">
            <h4>Asuransi Bencana Alam Eksklusif</h4>
            <p class="mb-3">Perlindungan ekstra untuk properti Anda. Amankan investasi Anda dari bencana dengan perlindungan kami.</p>
            <a href="#" class="more hover link-blue">Pelajari Selengkapnya</a>
          </div>
          <!--/.card-body -->
        </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card">
          <img class="card-img-top" src="../assets/img/kecelakaandiri.jpg" alt="" />
          <div class="card-body">
            <h4>Perlidungan Kecelakaan Diri</h4>
            <p class="mb-3">Nikmati perlindungan eksklusif dari risiko kecelakaan. Jamin masa depan Anda dengan perlindungan premium kami!</p>
            <a href="#" class="more hover link-primary">Pelajari Selengkapnya</a>
          </div>
          <!--/.card-body -->
        </div>
