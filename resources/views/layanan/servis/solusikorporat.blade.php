...
<head>
    ...
    <title>SentrySafe | Solusi Korporat</title>
...
<section class="wrapper image-wrapper bg-image bg-overlay text-white fixed-bg" data-image-src="../assets/img/corporat2.jpg">
    <div class="container py-md-15">
        <div class="row">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="post-header">
                    <h1 class="display-1 mb-3 text-white">Solusi Korporat</h1>
...
<section class="wrapper">
    ...
    <div class="row">
      <div class="col-lg-6 col-xl-5 col-xxl-4">
        <h2 class="fs-15 text-uppercase text-muted mb-3">Perlindungan Korporat</h2>
        <h3 class="display-4 mb-7 mt-n2">Jenis Asuransi Korporat Yang Kami Tawarkan</h3>
      </div>
      <!-- /column -->
    </div>
      <!-- /.row -->
      <div class="row gx-md-8 gy-8 justify-content-center">
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img-top" src="../assets/img/korpo/bisnis.jpg" alt="Perlindungan Pendidikan Elite" />
                <div class="card-body">
                    <h4>Asuransi Bisnis</h4>
                    <p class="mb-3">Meliputi asuransi gangguan bisnis, kredit perdagangan, dan tanggung gugat.</p>
                    <div class=" justify-content-center">
                        <a href="#" class="btn btn-outline-primary btn-sm me-2" style="width: 45%;">Selengkapnya</a>
                        <a href="#" class="btn btn-outline-primary btn-sm" style="width: 45%;">Bandingkan</a>
                    </div>
                </div>
                <!--/.card-body -->
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card">
            <img class="card-img-top" src="../assets/img/korpo/jiwakarya.jpg" alt="" />
            <div class="card-body">
              <h4>Asuransi Jiwa Karyawan</h4>
              <p class="mb-3">Memberikan manfaat keuangan langsung bagi keluarga karyawan jika meninggal dunia.</p>
              <div class=" justify-content-center">
                <a href="#" class="btn btn-outline-primary btn-sm me-2" style="width: 45%;">Selengkapnya</a>
                <a href="#" class="btn btn-outline-primary btn-sm" style="width: 45%;">Bandingkan</a>
            </div>            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card">
            <img class="card-img-top" src="../assets/img/korpo/kecekerja.png" alt="" />
            <div class="card-body">
              <h4>Asuransi Kecelakaan Kerja</h4>
              <p class="mb-3">Melindungi karyawan dari cedera atau penyakit terkait langsung dengan pekerjaan.</p>
              <div class=" justify-content-center">
                <a href="#" class="btn btn-outline-primary btn-sm me-2" style="width: 45%;">Selengkapnya</a>
                <a href="#" class="btn btn-outline-primary btn-sm" style="width: 45%;">Bandingkan</a>
            </div>            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card">
            <img class="card-img-top" src="../assets/img/korpo/gugat.jpg" alt="" />
            <div class="card-body">
              <h4>Asuransi Tanggung Gugat Korporat</h4>
              <p class="mb-3">Melindungi perusahaan dari klaim hukum terkait kelalaian, kesalahan, atau tuntutan.</p>
              <div class=" justify-content-center">
                <a href="#" class="btn btn-outline-primary btn-sm me-2" style="width: 45%;">Selengkapnya</a>
                <a href="#" class="btn btn-outline-primary btn-sm" style="width: 45%;">Bandingkan</a>
            </div>            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card">
            <img class="card-img-top" src="../assets/img/korpo/property.jpg" alt="" />
            <div class="card-body">
              <h4>Asuransi Properti Korporat</h4>
              <p class="mb-3">Melindungi aset perusahaan dari kebakaran, pencurian, atau kerusakan lainnya.</p>
              <div class=" justify-content-center">
                <a href="#" class="btn btn-outline-primary btn-sm me-2" style="width: 45%;">Selengkapnya</a>
                <a href="#" class="btn btn-outline-primary btn-sm" style="width: 45%;">Bandingkan</a>
            </div>            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card">
            <img class="card-img-top" src="../assets/img/korpo/kesehatankarya.jpg" alt="" />
            <div class="card-body">
                <h4>Asuransi Kesehatan Karyawan</h4>
                <p class="mb-3">Memberikan perlindungan kesehatan untuk karyawan dan keluarga, termasuk rawat inap.</p>
              <div class=" justify-content-center">
                <a href="#" class="btn btn-outline-primary btn-sm me-2" style="width: 45%;">Selengkapnya</a>
                <a href="#" class="btn btn-outline-primary btn-sm" style="width: 45%;">Bandingkan</a>
            </div>            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card">
            <img class="card-img-top" src="../assets/img/korpo/sejahtera.jpg" alt="" />
            <div class="card-body">
              <h4>Asuransi Kesejahteraan Karyawan</h4>
              <p class="mb-3">Produk untuk kesejahteraan karyawan, seperti asuransi kebugaran atau program kerja.</p>
              <div class=" justify-content-center">
                <a href="#" class="btn btn-outline-primary btn-sm me-2" style="width: 45%;">Selengkapnya</a>
                <a href="#" class="btn btn-outline-primary btn-sm" style="width: 45%;">Bandingkan</a>
            </div>            </div>
